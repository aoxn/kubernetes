...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_OSSVolumeSource, InType: reflect.TypeOf(&OSSVolumeSource{})},
...
func DeepCopy_api_OSSVolumeSource(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*OSSVolumeSource)
		out := out.(*OSSVolumeSource)
